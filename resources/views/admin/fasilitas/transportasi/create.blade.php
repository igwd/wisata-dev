  ...
  <div class="row">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{url('/')}}/admin/fasilitas/transportasi">Transportasi</a></li>
        <li class="breadcrumb-item active" aria-current="page">Create - {{@$data->nama_fasilitas}}</li>
      </ol>
    </nav>
      <div class="col-md-12 card">
        <div class="card-body">
          ...
          @endif
          <form id="form-data" name="form-data" method="POST" enctype="multipart/form-data" action="{{url('/')}}/admin/fasilitas/transportasi/store">
            <!-- form reqiure laravel -->
            <input type="hidden" name="_method" value="PUT">
            @csrf
            <!-- form require laravel end -->
            <div class="form-group">
              <input type="hidden" name="group_kategori" value="TRANSPORT">
...
<script type="text/javascript">
  let markers = [];
  let map;
  const image = "{{url('/public/marker/transport.png')}}";
  $(document).ready(function(){
    ...
    $('#btn-batal').click(function(){
      window.location.href = "{{url('/admin/fasilitas/transportasi')}}"; 
    });

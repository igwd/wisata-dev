		...
		<div class="col-md-12">
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item"><a href="{{url('/')}}/admin/galeri/video">Video</a></li>
				</ol>
			</nav>
		</div>
	</div>
...
$(document).ready(function() {
	$('#btn-add').click(function(){
		window.location.href="{{url('admin/galeri/video/create')}}"
	});

	$("#search").on('keyup', function (e) {
	    if (e.key === 'Enter' || e.keyCode === 13) {
	    	if($(this).val() !== ""){
		        window.location.href = '{{url("admin/galeri/video?search=")}}'+$(this).val();
		    }else{

    ...
    <nav aria-label="breadcrumb">
      ...
      <div class="col-md-12 card">
        <div class="card-body">
          ...
          @endif
          <form id="form-data" name="form-data" method="POST" enctype="multipart/form-data" action="{{url('/')}}/admin/fasilitas/penginapan/store">
            <!-- form reqiure laravel -->
            <input type="hidden" name="_method" value="PUT">
            @csrf
            <!-- form require laravel end -->
            <div class="form-group">
              <input type="hidden" name="group_kategori" value="PENGINAPAN">
...
<script type="text/javascript">
  let markers = [];
  let map;
  const image = "{{url('/public/marker/homestay.png')}}";
  $(document).ready(function(){
    ...
    $('#btn-batal').click(function(){
      window.location.href = "{{url('/admin/fasilitas/penginapan')}}"; 
    });

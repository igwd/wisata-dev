...
class TransportasiController extends Controller
{
    ...
    {
        return view('admin.fasilitas.transportasi.index');
    }
    ...
    {
        return view('admin.fasilitas.transportasi.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        if(empty($url_gambar)){
            ...
            if($fasilitas->save()){
                $id = $fasilitas->id;
                session()->flash('message', array('class'=>'alert-success','text'=>array('Berhasil tambah data Transportasi - '.$request->nama_fasilitas)));
            }else{
                session()->flash('message', array('class'=>'alert-danger','text'=>array('Gagal tambah data Transportasi - '.$request->nama_fasilitas)));
            }
        }
        $data = (object) $request->input();
        if(!empty($errors)){
            return view('admin.fasilitas.transportasi.create',compact("data"));
        }else{
            return redirect('admin/fasilitas/transportasi/'.$id.'/edit');
        }
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.fasilitas.transportasi.edit',compact('data'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if(empty($url_gambar)){
            ...
            if($simpan){
                session()->flash('message', array('class'=>'alert-success','text'=>array('Berhasil <i>update</i> data Transportasi - '.$request->nama_fasilitas)));
            }else{
                session()->flash('message', array('class'=>'alert-danger','text'=>array('Gagal <i>update</i> data Transportasi - '.$request->nama_fasilitas)));
            }
        }
        return redirect('admin/fasilitas/transportasi/'.$id.'/edit');
    }
    ...
    public function listData(Request $request){
        ...
        ])->where('group_kategori','TRANSPORT');
        ...
        return $datatables
            ...
            ->addcolumn('fasilitas', function ($data) {
                ...
                $url_delete = url('/')."/admin/fasilitas/transportasi/{$data->id}/destroy";

...
<section id="mu-course-content">
	@php
		...
		echo "</pre>";
		*/
		$data_booking = (array)@$data['booking'];
	                        ...
	                        <div class="row">
	                          <div class="col-md-4">
	                          	<div class="form-group">
	                          		<label>Nama</label>
	                          		<input type="text" name="nama" id="nama" class="form-control" required="" value="{{@$booking->nama}}">
	                          	</div>
	                          </div>
	                          <div class="col-md-4">
	                          	<div class="form-group">
	                          		<label>Email</label>
	                          		<input type="email" name="email" id="email" class="form-control" required="" value="{{@$booking->email}}">
	                          	</div>
	                          </div>
	                          <div class="col-md-4">
	                          	<div class="form-group">
	                          		<label>Phone</label>
	                          		<input type="text" name="telp" id="telp" class="form-control" required="" value="{{@$booking->telp}}">
	                          	</div>
	                          </div>
	                        </div>
	                        <h4>Data Tiket</h4>
		                      	...
		                      	<div class="col-md-4">
		                      		<div class="form-group">
		                        		<label style="text-align: right !important;">Tanggal Booking</label>
												        <input type="text" readonly style="text-align: right; padding-right: 15px;" class="datepicker form-control" id="tanggal" name="tanggal" value="{!!(!empty($booking->tanggal) ? @$booking->tanggal : date('Y-m-d')) !!}">
		                      		</div>
		                      	</div>
		                      </div>
		                        ...
		                        <div class="table-responsive">
		                          ...
		                          <tbody>
		                            ...
		                            <tr>
		                              ...
		                              <td><input class="btn btn-danger btn-sm" type="button" value="Delete" onclick="deleteRow(this)"/></td>
		                            </tr>
